...
export default class Animation
{
	...
	getCurrentFrame() { return this.frames[this.currentFrame]; }
	isHalfwayDone()   { return this.currentFrame >= this.frames.length / 2; }
	isDone()          { return this.timesPlayed === this.cycles; }
}